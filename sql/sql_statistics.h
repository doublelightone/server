...
{
  LEX_STRING od= { const_cast<char*>(db), (uint)strlen(db) };
  LEX_STRING ot= { const_cast<char*>(tab), (uint)strlen(tab) };
  LEX_STRING nd= { const_cast<char*>(new_db), (uint)strlen(new_db) };
  LEX_STRING nt= { const_cast<char*>(new_tab), (uint)strlen(new_tab) };
